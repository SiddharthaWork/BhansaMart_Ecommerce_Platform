...
const columns = [
    ...
    },
    {
        ...
        render: (_: any, OrdersListItem: any) => (
          <div
            className={`p-2 w-fit rounded-lg text-center bg-red-400 ${
...
const _SettleDeliveryDetail = ({ onClose }: { onClose: () => void }) => {
    return (
    ...
    <div className="bg-white rounded-lg p-6 max-w-md w-full">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <label htmlFor="discrepancy" className="font-medium">
            Discrepancy:
          </label>
          <span className="text-gray-500">Rs. 500</span>
        </div>
        <div className='flex'>
          <label htmlFor="cash-received" className="block font-medium mb-2 w-full">
            Cash Received:
          </label>
          <input
            id="cash-received"
        ...
        <div className='flex'>
          <label htmlFor="comments" className="block font-medium mb-2 w-full">
            Comments:
          </label>
          <textarea
            id="comments"
        ...
        <button
          type="submit"
          className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-md w-fit"
        >
          Submit
        </button>
      </div>
...
export default _SettleDeliveryDetail