...
interface _rejectedDeliveryPersonRequestProps {
  driver: _User[];
  paginationDetails: {
    currentPage: number;
    limit: number;
...
export const RejectedDeliveryPersonRequest = ({
  driver,
  paginationDetails,
  setPaginationDetails,
  isLoading
}: _rejectedDeliveryPersonRequestProps) => {
  const rejectedDeliveryPersonRequestColumns = [
    {
      key: '',
      header: 'Driver Name',
    ...
    },
    {
      ...
      render: (_: any, data: any) => {
        return (
          <span
            className={`p-1 rounded bg-fade-orange text-[#F87D08]
            `}
          >
            Rejected
          </span>
  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      <section className="mt-2 ">
        ...
        <Table
          columns={rejectedDeliveryPersonRequestColumns}
          data={drivers ?? []}
          showPagination
