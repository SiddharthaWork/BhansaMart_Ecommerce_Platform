...
const OrderListFilter: React.FC<IOrder> = ({
  newOrdersList,
  setNewOrderData,
  setPaginationDetails,
  // originalOrderList
}) => {
  const[originalOrderList, setOriginalOrderList] = useState(newOrdersList);
  ...
  const handleApply = () => {
    const filteredData = filterActions.applyFilters(originalOrderList);
