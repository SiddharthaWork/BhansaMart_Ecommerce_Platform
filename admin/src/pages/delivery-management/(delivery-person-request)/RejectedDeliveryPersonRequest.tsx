import { RejectedDeliveryPersonRequest } from '@/components/ui/delivery-management/(delivery-person-request)/Rejected-Delivery-Person-Request';
import { useFetchuserByRole } from '@/server-action/api/user';
import { useState } from 'react';

export const RejectedDeliveryPersonRequestPage = () => {
